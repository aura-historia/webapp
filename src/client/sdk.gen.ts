 ...
 *
 */
export const postWoocommerceWebhook = <ThrowOnError extends boolean = false>(options: Options<PostWoocommerceWebhookData, ThrowOnError>) => (options.client ?? client).post<PostWoocommerceWebhookResponses, PostWoocommerceWebhookErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getSearchFilterLiveProducts = <ThrowOnError extends boolean = false>(options: Options<GetSearchFilterLiveProductsData, ThrowOnError>) => (options.client ?? client).get<GetSearchFilterLiveProductsResponses, GetSearchFilterLiveProductsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getSearchFilterMatches = <ThrowOnError extends boolean = false>(options: Options<GetSearchFilterMatchesData, ThrowOnError>) => (options.client ?? client).get<GetSearchFilterMatchesResponses, GetSearchFilterMatchesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const updateSearchFilterMatchFeedback = <ThrowOnError extends boolean = false>(options: Options<UpdateSearchFilterMatchFeedbackData, ThrowOnError>) => (options.client ?? client).patch<UpdateSearchFilterMatchFeedbackResponses, UpdateSearchFilterMatchFeedbackErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const patchMyAccessToken = <ThrowOnError extends boolean = false>(options: Options<PatchMyAccessTokenData, ThrowOnError>) => (options.client ?? client).patch<PatchMyAccessTokenResponses, PatchMyAccessTokenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/me/access-tokens',
    ...options,
    headers: {
 ...
 *
 */
export const postMyAccessToken = <ThrowOnError extends boolean = false>(options: Options<PostMyAccessTokenData, ThrowOnError>) => (options.client ?? client).post<PostMyAccessTokenResponses, PostMyAccessTokenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/me/access-tokens',
    ...options,
    headers: {
 ...
 *
 */
export const deleteMyAccessToken = <ThrowOnError extends boolean = false>(options: Options<DeleteMyAccessTokenData, ThrowOnError>) => (options.client ?? client).delete<DeleteMyAccessTokenResponses, DeleteMyAccessTokenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getMyAccessToken = <ThrowOnError extends boolean = false>(options: Options<GetMyAccessTokenData, ThrowOnError>) => (options.client ?? client).get<GetMyAccessTokenResponses, GetMyAccessTokenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/me/access-tokens/{accessTokenId}',
    ...options
});
 ...
 *
 */
export const simpleSearchShops = <ThrowOnError extends boolean = false>(options?: Options<SimpleSearchShopsData, ThrowOnError>) => (options?.client ?? client).get<SimpleSearchShopsResponses, SimpleSearchShopsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/api/v1/shops',
    ...options
});
 ...
 *
 */
export const getShopById = <ThrowOnError extends boolean = false>(options: Options<GetShopByIdData, ThrowOnError>) => (options.client ?? client).get<GetShopByIdResponses, GetShopByIdErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getShopBySlug = <ThrowOnError extends boolean = false>(options: Options<GetShopBySlugData, ThrowOnError>) => (options.client ?? client).get<GetShopBySlugResponses, GetShopBySlugErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getShopByDomain = <ThrowOnError extends boolean = false>(options: Options<GetShopByDomainData, ThrowOnError>) => (options.client ?? client).get<GetShopByDomainResponses, GetShopByDomainErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const getMyPartnerShops = <ThrowOnError extends boolean = false>(options?: Options<GetMyPartnerShopsData, ThrowOnError>) => (options?.client ?? client).get<GetMyPartnerShopsResponses, GetMyPartnerShopsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const oauthAuthorize = <ThrowOnError extends boolean = false>(options: Options<OauthAuthorizeData, ThrowOnError>) => (options.client ?? client).get<unknown, OauthAuthorizeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const oauthRevoke = <ThrowOnError extends boolean = false>(options: Options<OauthRevokeData, ThrowOnError>) => (options.client ?? client).post<OauthRevokeResponses, OauthRevokeErrors, ThrowOnError>({
    ...urlSearchParamsBodySerializer,
 ...
 *
 */
export const oauthIntrospect = <ThrowOnError extends boolean = false>(options: Options<OauthIntrospectData, ThrowOnError>) => (options.client ?? client).post<OauthIntrospectResponses, OauthIntrospectErrors, ThrowOnError>({
    ...urlSearchParamsBodySerializer,
 ...
 *
 */
export const getOAuthClients = <ThrowOnError extends boolean = false>(options?: Options<GetOAuthClientsData, ThrowOnError>) => (options?.client ?? client).get<GetOAuthClientsResponses, GetOAuthClientsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 */
export const postOAuthClient = <ThrowOnError extends boolean = false>(options: Options<PostOAuthClientData, ThrowOnError>) => (options.client ?? client).post<PostOAuthClientResponses, PostOAuthClientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/oauth/clients',
    ...options,
    headers: {
 ...
 *
 */
export const getOAuthClient = <ThrowOnError extends boolean = false>(options: Options<GetOAuthClientData, ThrowOnError>) => (options.client ?? client).get<GetOAuthClientResponses, GetOAuthClientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/oauth/clients/{clientId}',
    ...options
});
 ...
 *
 */
export const patchOAuthClient = <ThrowOnError extends boolean = false>(options: Options<PatchOAuthClientData, ThrowOnError>) => (options.client ?? client).patch<PatchOAuthClientResponses, PatchOAuthClientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/oauth/clients/{clientId}',
    ...options,
    headers: {
