 ...
 *
 */
export const getSearchFilterPreviewProducts = <ThrowOnError extends boolean = false>(options: Options<GetSearchFilterPreviewProductsData, ThrowOnError>) => (options.client ?? client).get<GetSearchFilterPreviewProductsResponses, GetSearchFilterPreviewProductsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
