...
export type GetItemData2 = {
    ...
    headers?: {
         ...
         * When provided, response includes user-specific state (watchlist status, notifications).
...
export type ComplexSearchItemsData = {
    ...
    headers?: {
        /**
         * Optional Cognito JWT token for personalized response.
         * When provided, response includes user-specific state for each item (watchlist status, notifications).
         * When omitted, response contains only item data without user state.
         *
         */
        Authorization?: string;
