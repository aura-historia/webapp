...
export function PartnerApplicationCreateDialog({
    ...
    const handleCreateSuccess = () => {
        toast.success(t("partnerDashboard.create.success"));
        resetForm();
        onOpenChange(false);
    };
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
                <DialogHeader>
                    <DialogTitle>{t("partnerDashboard.create.title")}</DialogTitle>
                    <DialogDescription>
                        {t("partnerDashboard.create.description")}
                    </DialogDescription>
                </DialogHeader>
                ...
                >
                    <div className="grid gap-2 pb-5">
                        <Label htmlFor="partner-application-type">
                            {t("partnerDashboard.create.fields.type")}
                        </Label>
                        <Select
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value="NEW">
                                    {t("partnerDashboard.create.type.new")}
                                </SelectItem>
                                <SelectItem value="EXISTING">
                                    {t("partnerDashboard.create.type.existing")}
                                </SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    ...
                    <DialogFooter>
                        ...
                        >
                            {t("partnerDashboard.create.cancel")}
                        </Button>
                        <Button type="submit" disabled={submitDisabled}>
                            {createPartnerApplication.isPending
                                ? t("partnerDashboard.create.submitting")
                                : t("partnerDashboard.create.submit")}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
