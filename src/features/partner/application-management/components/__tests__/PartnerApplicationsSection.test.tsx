...
const mockUsePartnerApplicationShopSearch = vi.hoisted(() => vi.fn());
...
vi.mock("@/features/partner/application-management/api/usePartnerApplicationShopSearch.ts", () => ({
    usePartnerApplicationShopSearch: mockUsePartnerApplicationShopSearch,
}));
...
describe("PartnerApplicationsSection", () => {
    beforeEach(() => {
        ...
        mockUsePartnerApplicationShopSearch.mockReturnValue({
            data: [
                {
