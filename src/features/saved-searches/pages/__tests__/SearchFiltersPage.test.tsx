...
import { SearchFiltersPage } from "../SearchFiltersPage.tsx";
...
vi.mock("@/features/saved-searches/api/useUserSearchFilters.ts", () => ({
    useUserSearchFilters: mockUseUserSearchFilters,
}));

vi.mock("@/features/saved-searches/api/useDeleteUserSearchFilter.ts", () => ({
...
vi.mock("@/features/saved-searches/components/CreateSearchFilterWizard.tsx", () => ({
    CreateSearchFilterWizard: () => null,
}));

vi.mock("@/features/saved-searches/components/SearchFilterCard.tsx", () => ({
    SearchFilterCard: ({ filter }: { filter: UserSearchFilter }) => (
        <div data-testid="search-filter-card">{filter.name}</div>
    ),
}));

vi.mock("@/features/saved-searches/components/SearchFilterCardSkeleton.tsx", () => ({
...
describe("SearchFiltersPage", () => {
    ...
    describe("Loading state", () => {
        it("renders skeleton cards while loading", () => {
            ...
            renderWithQueryClient(<SearchFiltersPage />);
    ...
    describe("Null data", () => {
        it("renders nothing when data is undefined and not loading", () => {
            ...
            const { container } = renderWithQueryClient(<SearchFiltersPage />);
