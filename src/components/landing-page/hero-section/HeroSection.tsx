...
import {
    HERO_PAINTING_URL,
    TRUST_BADGE_KEYS,
} from "@/components/landing-page/hero-section/HeroSection.data.ts";
...
export default function HeroSection() {
    ...
    return (
        <section className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden">
            {/* Classic painting background with overlay */}
            ...
            <div className="w-full max-w-4xl px-4 relative z-10">
                ...
                <H1 className="text-center hyphens-none text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight">
                ...
                <Card
                    className={`p-6 sm:mt-12 mt-6 shadow-lg border-primary/10 transition-all duration-500 ease-in-out ${
                ...
                {/* Scroll indicator */}
                <div
                    className={`flex justify-center mt-8 transition-opacity duration-500 ${isScrolled ? "opacity-0" : "opacity-60"}`}
                >
