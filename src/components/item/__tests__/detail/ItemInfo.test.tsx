...
import { ItemInfo } from "../../detail/ItemInfo.tsx";
...
describe("ItemInfo", () => {
    ...
    it("should render the item title, shop name, and price correctly", () => {
        renderWithQueryClient(<ItemInfo item={mockItem} />);
    ...
    it("should render 'Keine Beschreibung verfügbar' when description is not provided", () => {
        ...
        renderWithQueryClient(<ItemInfo item={itemWithoutDescription} />);
    ...
    it("should render 'Preis unbekannt' when price is not provided", () => {
        ...
        renderWithQueryClient(<ItemInfo item={itemWithoutPrice} />);
