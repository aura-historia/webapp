...
import { ItemSimilarCard } from "../../detail/ItemSimilarCard.tsx";
...
describe("ItemSimilarCard", () => {
    const mockItem: OverviewItem = {
        itemId: "1",
        eventId: "",
        shopId: "shop-123",
        shopsItemId: "item-456",
        shopName: "Test Shop",
    ...
    it("should render the item title, shop name, and price correctly", () => {
        render(<ItemSimilarCard item={mockItem} />);
    ...
    it("should render the item image when provided", () => {
        const { container } = render(<ItemSimilarCard item={mockItem} />);
    ...
    it("should render a placeholder when no images are provided", () => {
        ...
        render(<ItemSimilarCard item={itemWithoutImages} />);
    ...
    it("should render 'Preis unbekannt' when price is not provided", () => {
        ...
        render(<ItemSimilarCard item={itemWithoutPrice} />);
    ...
    it("should render the status badge with 'Verkauft' for SOLD state", () => {
        ...
        render(<ItemSimilarCard item={soldItem} />);
    ...
    it("should render the status badge with 'Reserviert' for RESERVED state", () => {
        ...
        render(<ItemSimilarCard item={reservedItem} />);
    ...
    it("should truncate long titles correctly with line-clamp", () => {
        ...
        render(<ItemSimilarCard item={itemWithLongTitle} />);
    ...
    it("should truncate long shop names correctly with line-clamp", () => {
        ...
        render(<ItemSimilarCard item={itemWithLongShopName} />);
    ...
    it("should render multiple images by showing only the first one", () => {
        ...
        const { container } = render(<ItemSimilarCard item={itemWithMultipleImages} />);
    ...
    it("should handle empty price string", () => {
        ...
        render(<ItemSimilarCard item={itemWithEmptyPrice} />);
