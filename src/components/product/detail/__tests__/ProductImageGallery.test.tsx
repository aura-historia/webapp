...
describe("ProductImageGallery", () => {
    ...
    it("should show navigation buttons when there are multiple images", () => {
        render(<ProductImageGallery images={multipleImages} title="Test Product" productId="1" />);
        const buttons = screen.getAllByRole("button");
    ...
    it("should reset image index when productId changes", () => {
        const { rerender } = render(
            <ProductImageGallery images={multipleImages} title="Test Product" productId="1" />,
        );
